...
public class DesignTacoController {
	...
	private final IngredientRepository ingredientRespo;
	
	private TacoRepository designRepo;
	
	@Autowired
	public DesignTacoController(IngredientRepository ingredientRespo, TacoRepository designRepo) {
		this.ingredientRespo = ingredientRespo;
...
//				new Ingredient("SLSA", "Salsa", Type.SAUCE), new Ingredient("SRCR", "Sour Cream", Type.SAUCE));
		...
		ingredientRespo.findAll().forEach(i -> ingredients.add(i));
